...
export class FeishuAdapter extends BaseChannelAdapter {
  ...
  private async _doCreateStreamingCard(chatId: string, replyToMessageId?: string): Promise<boolean> {
    ...
    try {
      const navContext = this.getStreamingCardContext(chatId);
      const cardBody = {
        schema: '2.0',
        config: {
          streaming_mode: true,
  ...
  private async finalizeCard(
    ...
    try {
      ...
      const finalCardJson = buildFinalCardJson(responseText, state.toolCalls, footer, this.getStreamingCardContext(chatId));
  ...
  private getStreamingCardContext(chatId: string): FeishuStreamingCardContext | null {
