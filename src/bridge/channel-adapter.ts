...
export abstract class BaseChannelAdapter {
  ...
  onMessageStart?(_chatId: string, _context?: StreamContext): void;

  /** Called when message processing ends. */
  onMessageEnd?(_chatId: string, _context?: StreamContext): void;
   ...
   */
  onStreamText?(_chatId: string, _fullText: string, _context?: StreamContext): void;
   ...
   */
  onToolEvent?(_chatId: string, _tools: import('./types.js').ToolCallInfo[], _context?: StreamContext): void;
